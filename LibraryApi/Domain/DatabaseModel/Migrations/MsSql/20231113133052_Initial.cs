    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Books_Authors", x => new { x.AuthorId, x.BookId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RezervationStartDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RezervationEndDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
